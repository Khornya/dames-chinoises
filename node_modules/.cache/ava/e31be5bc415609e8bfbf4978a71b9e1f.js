...
(0, _ava2.default)('Désactiver les tooltips', t => {
  ...
  // t.is(tooltip.style,undefined);
  // }
  console.log(document.querySelectorAll('.tooltip'));
  Client.deactivateTooltips();
  t.is(document.querySelector('.tooltip').style.display, 'none');
});
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/e31be5bc415609e8bfbf4978a71b9e1f.js.map