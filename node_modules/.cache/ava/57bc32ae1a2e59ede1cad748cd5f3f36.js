...
(0, _ava2.default)('Désactiver les tooltips', t => {
  for (var tooltip in document.querySelectorAll('.tooltip')) {
    ...
    t.falsy(_rec._expr(_rec._capt(_rec._capt(tooltip, 'arguments/0/object').style, 'arguments/0'), {
      content: 't.falsy(tooltip.style)',
      filepath: 'client.test.js',
      line: 19,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"tooltip","range":[8,15]},"property":{"type":"Identifier","name":"style","range":[16,21]},"computed":false,"range":[8,21]}],"range":[0,22]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"tooltip","range":[8,15]},{"type":{"label":"."},"range":[15,16]},{"type":{"label":"name"},"value":"style","range":[16,21]},{"type":{"label":")"},"range":[21,22]}]',
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/57bc32ae1a2e59ede1cad748cd5f3f36.js.map