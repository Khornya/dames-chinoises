...
(0, _ava2.default)('Créer une case sur le plateau de jeu', t => {
  t.is(Client.createCell([10, 8], 2).innerHTML, '<div class="cell" line="10" column="8"><img alt="pion" src="images/pion2.png"></div>');
  t.is(Client.createCell([0, 5], -1).innerHTML, '<div class="cell" line="0" column="5"><img alt="pion" src="images/pion-1.png"></div>');
});

_ava2.default.skip('Redémarrer une partie', t => {});

_ava2.default.skip('Actualiser le plateau de jeu', t => {});

_ava2.default.skip('Afficher le message de fin de partie', t => {});

_ava2.default.skip('Jouer un coup', t => {});

_ava2.default.skip('Effectuer un déplacement', t => {});

_ava2.default.skip('Créer un objet de la classe Player', t => {});

_ava2.default.skip('Créer un objet de la classe Sound', t => {});

_ava2.default.skip('Actualiser les cadres des joueurs', t => {});

_ava2.default.skip('Afficher un message', t => {});
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/d4d2c2e9edf490fc65ba7d59681c41ea.js.map