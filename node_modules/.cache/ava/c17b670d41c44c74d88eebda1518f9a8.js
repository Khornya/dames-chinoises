...
(0, _ava2.default)('Désactiver / réactiver un joueur joué par l\'IA', t => {
  ...
  t.false(_rec4._expr(_rec4._capt(_rec4._capt(_rec4._capt(document, 'arguments/0/object/callee/object').querySelector('#player3'), 'arguments/0/object').disabled, 'arguments/0'), {
    content: 't.false(document.querySelector(\'#player3\').disabled)',
    filepath: 'client.test.js',
    line: 59,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"document","range":[8,16]},"property":{"type":"Identifier","name":"querySelector","range":[17,30]},"computed":false,"range":[8,30]},"arguments":[{"type":"StringLiteral","value":"#player3","range":[31,41]}],"range":[8,42]},"property":{"type":"Identifier","name":"disabled","range":[43,51]},"computed":false,"range":[8,51]}],"range":[0,52]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"document","range":[8,16]},{"type":{"label":"."},"range":[16,17]},{"type":{"label":"name"},"value":"querySelector","range":[17,30]},{"type":{"label":"("},"range":[30,31]},{"type":{"label":"string"},"value":"#player3","range":[31,41]},{"type":{"label":")"},"range":[41,42]},{"type":{"label":"."},"range":[42,43]},{"type":{"label":"name"},"value":"disabled","range":[43,51]},{"type":{"label":")"},"range":[51,52]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
  t.is(document.querySelector('#player3').value, '');
  t.is(document.querySelector('#level_choice').style.display, 'block');
  document.querySelector('#ordi2').checked = false; // on décoche la case IA du joueur 2
  Client.disablePlayer(2);
  t.is(document.querySelector('#level_choice').style.display, 'block');
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/c17b670d41c44c74d88eebda1518f9a8.js.map