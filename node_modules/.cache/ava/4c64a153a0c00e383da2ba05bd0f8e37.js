...
(0, _ava2.default)('Vérifier le nom d\'un joueur', t => {
  ...
  t.is(tooltip.innerHTML, 'Le nom doit comprendre :<br>- 2 à 10 caractères alphanumériques<br>ou des tirets'); // on change le texte du tooltip
  t.is(tooltip.style.display, 'inline-block'); // on affiche le tooltip
});

_ava2.default.skip('Vérifier un numéro de partie', t => {
  document.write(pug.renderFile('./views/index.pug', {})); // écrit la page d'accueil dans la simulation du DOM
});
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/4c64a153a0c00e383da2ba05bd0f8e37.js.map