...
(0, _ava2.default)('Créer une case sur le plateau de jeu', t => {
  document.write(pug.renderFile('./views/game.pug', {})); // écrit la page d'accueil dans la simulation du DOM
  t.is(document.getElementById('board').innerHTML, '');
  Client.createCell([10, 8], 2);
  t.is(document.getElementById('board').innerHTML, '<div class="cell" line="10" column="8"><img alt="pion" src="images/pion2.png"></div>');
});
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/6dadbeb8171e645b4b5d79d0ac4d64d6.js.map