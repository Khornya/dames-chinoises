...
_ava2.default.before(async t => {
    await client.init().url('http://localhost:8000');
});

_ava2.default.after.always(async t => {
    await client.end();
});

(0, _ava2.default)('has a title', t => {
    return client.isExisting('title').then(result => {
        var _rec = new _powerAssertRecorder();

        t.true(_rec._expr(_rec._capt(result, 'arguments/0'), {
            content: 't.true(result)',
            filepath: 'test/specs/uitest.js',
            line: 20,
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/5c56674776cf9ab8f63f8886ad7999ad.js.map