...
Client.__set__('SOUNDS.win.play', () => {
  lastPlayedSound = 'win';
});
Client.__set__('SOUNDS.fail.play', () => {
  lastPlayedSound = 'fail';
});
Client.__set__('SOUNDS.jump.play', () => {
  lastPlayedSound = 'jump';
});
Client.__set__('alert', message => {
  lastAlert = message;
});

(0, _ava2.default)('Créer le plateau de jeu', t => {
...
(0, _ava2.default)('Créer une case sur le plateau de jeu', t => {
...
_ava2.default.skip('Redémarrer une partie', t => {
  var _rec = new _powerAssertRecorder();

  Client.__set__('updatePlayerFrames', _sinon2.default.spy());
  Client.restart();
  t.true(_rec._expr(_rec._capt(_rec._capt(_rec._capt(Client, 'arguments/0/object/callee/object').__get__('updatePlayerFrames'), 'arguments/0/object').calledOnce, 'arguments/0'), {
    content: 't.true(Client.__get__(\'updatePlayerFrames\').calledOnce)',
    filepath: 'client.game.test.js',
    line: 42,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"MemberExpression","object":{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"Client","range":[7,13]},"property":{"type":"Identifier","name":"__get__","range":[14,21]},"computed":false,"range":[7,21]},"arguments":[{"type":"StringLiteral","value":"updatePlayerFrames","range":[22,42]}],"range":[7,43]},"property":{"type":"Identifier","name":"calledOnce","range":[44,54]},"computed":false,"range":[7,54]}],"range":[0,55]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"Client","range":[7,13]},{"type":{"label":"."},"range":[13,14]},{"type":{"label":"name"},"value":"__get__","range":[14,21]},{"type":{"label":"("},"range":[21,22]},{"type":{"label":"string"},"value":"updatePlayerFrames","range":[22,42]},{"type":{"label":")"},"range":[42,43]},{"type":{"label":"."},"range":[43,44]},{"type":{"label":"name"},"value":"calledOnce","range":[44,54]},{"type":{"label":")"},"range":[54,55]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});

(0, _ava2.default)('Actualiser le plateau de jeu', t => {
...
(0, _ava2.default)('Afficher le message de fin de partie', t => {
...
_ava2.default.skip('Jouer un coup', t => {});

_ava2.default.skip('Effectuer un déplacement', t => {});

(0, _ava2.default)('Créer un objet de la classe Player', t => {
  document.write(pug.renderFile('./views/game.pug', {})); // écrit la page de jeu dans la simulation du DOM
...
(0, _ava2.default)('Créer un objet de la classe Sound', t => {
...
(0, _ava2.default)('Actualiser les cadres des joueurs', t => {
...
(0, _ava2.default)('Afficher un message', t => {
  Client.sendMessage('Vous avez gagné !', SOUNDS.win);
  t.is(lastPlayedSound, 'win');
  t.is(lastAlert, 'Vous avez gagné !');
});
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/a1b6aa89b371670cd8b7e437a0f344b6.js.map