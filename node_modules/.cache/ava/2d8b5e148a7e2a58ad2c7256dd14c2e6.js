...
(0, _ava2.default)('Créer un objet de la classe Player', t => {
  var player = new Client.Player('John', [1, 3], 0, document.createElement(div));
  t.is(player.name, 'John');
  t.deepEqual(player.colors, [1, 3]);
  t.is(player.number, 0);
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/2d8b5e148a7e2a58ad2c7256dd14c2e6.js.map