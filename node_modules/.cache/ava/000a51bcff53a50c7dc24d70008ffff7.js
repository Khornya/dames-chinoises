...
(0, _ava2.default)('Afficher les options en fonctions du nombre de joueurs', t => {
  console.log(document.getElementById('ordi5'));
  document.getElementById("mode").options[document.getElementById("mode").selectedIndex].value = "2"; // on sélectionne le mode 2 joueurs
  document.getElementById('1').checked = true; // on sélectionne le mode 1 couleur
...
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/000a51bcff53a50c7dc24d70008ffff7.js.map