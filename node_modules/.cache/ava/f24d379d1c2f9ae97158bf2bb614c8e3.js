...
(0, _ava2.default)('Désactiver les tooltips', t => {
  ...
  for (var i = 0; i <= 7; i++) {
    t.is(window.getComputedStyle(tooltips[i]).getPropertyValue('display'), 'block');
  }
  // console.log(document.querySelectorAll('.tooltip'));
  Client.deactivateTooltips();
  for (var i = 0; i <= 7; i++) {
    t.is(tooltips[i].style, 'none');
  }
});
//# sourceMappingURL=/home/khornya/L2INF/Projet/dames-chinoises/node_modules/.cache/ava/f24d379d1c2f9ae97158bf2bb614c8e3.js.map