      ...
      <div id="test">
          <section id="game">
            ...
            <form name="form" id="form" action="game.php" target="_self" method="POST">
              ...
              <br />
              <div>
                <input type="text" name="player1" id="player1" placeholder="Joueur 1"/><span id="player1colors"></span><input type="checkbox" name="IA1" id="IA1" value="Ordinateur" onclick="disablePlayer(1)" /><label for="IA1" onclick="disablePlayer(1)">IA</label><span class="tooltip"></span>
              </div>
              <div>
                <input type="text" name="player2" id="player2" placeholder="Joueur 2"/><span id="player2colors"></span><input type="checkbox" name="IA2" id="IA2" value="Ordinateur" onclick="disablePlayer(2)" /><label for="IA2" onclick="disablePlayer(2)">IA</label><span class="tooltip"></span>
              </div>
              <div>
                <input type="text" name="player3" id="player3" placeholder="Joueur 3"/><span id="player3colors"></span><input type="checkbox" name="IA3" id="IA3" value="Ordinateur" onclick="disablePlayer(3)" /><label for="IA3" onclick="disablePlayer(3)">IA</label><span class="tooltip"></span>
              </div>
              <div>
                <input type="text" name="player4" id="player4" placeholder="Joueur 4"/><span id="player4colors"></span><input type="checkbox" name="IA4" id="IA4" value="Ordinateur" onclick="disablePlayer(4)" /><label for="IA4" onclick="disablePlayer(4)">IA</label><span class="tooltip"></span>
              </div>
              <div>
                <input type="text" name="player5" id="player5" placeholder="Joueur 5"/><span id="player5colors"></span><input type="checkbox" name="IA5" id="IA5" value="Ordinateur" onclick="disablePlayer(5)" /><label for="IA5" onclick="disablePlayer(5)">IA</label><span class="tooltip"></span>
              </div>
              <div>
                <input type="text" name="player6" id="player6" placeholder="Joueur 6"/><span id="player6colors"></span><input type="checkbox" name="IA6" id="IA6" value="Ordinateur" onclick="disablePlayer(6)" /><label for="IA6" onclick="disablePlayer(6)">IA</label><span class="tooltip"></span>
              </div>
